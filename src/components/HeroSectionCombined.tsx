...
const HeroSectionCombined = ({ contentVisible = true }: { contentVisible?: boolean }) => {
        ...
        <div className="container max-w-4xl mx-auto text-center">
          ...
          <div className="max-w-[720px] mx-auto mb-10">
            <div className="rounded-xl overflow-hidden shadow-lg">
              <div id="ifr_combined_wrapper" style={{ margin: "0 auto", width: "100%" }}>
...
export default HeroSectionCombined;
